  ...
  return (
    ...
    >
      <form className="relative bg-opacity-10 backdrop-blur-md border-2 border-white p-10 rounded-xl w-96">
        <h1 className="text-center text-2xl font-medium text-white mb-6">Login</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="border-b-2 border-white flex items-center gap-3 relative">
            ...
            <div className="relative w-full">
              ...
              />
              <i
                className={`ri-${showPassword ? "eye-line" : "eye-off-line"} absolute right-3 top-3 cursor-pointer text-white`}
        ...
        <button className="w-full py-3 bg-white text-black font-medium rounded-lg mt-6">Login</button>

        <p className="text-center text-white text-sm mt-4">
          Don't have an account? <Link to={'/register'} className="font-medium hover:underline">Register</Link>
        </p>
      </form>
    </div>
  );
